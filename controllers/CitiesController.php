...
class CitiesController extends Controller
{
    ...
    public function actionApi()
    {
        $curl = curl_init();
            ...
            //     echo $data->city_id.' '.$data->province_id.' '.$data->province.' '.$data->type.' '.$data->city_name.' '.$data->postal_code.'<br>' ;
            //     $kota = new Cities();
            //     $kota->city_id = $data->city_id;
            //     $kota->province_id = $data->province_id;
            //     $kota->province = $data->province;
            //     $kota->type = $data->type;
            //     $kota->city_name = $data->city_name;
            //     $kota->postal_code = $data->postal_code;
            //     $kota->save();
